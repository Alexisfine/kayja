  ...
  return (
    <>
        <div className='hidden md:inline  flex-col'>
            <div className='grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-y-10 px-32 py-14 bg-gray-100'>
        ...
        <div className='px-5 py-10 md:hidden bg-gray-100'>
            <Accordion type='single' collapsible className='w-full'>
                <AccordionItem value="item-1" className="w-full" onClick={() => handleOpen(1)}>
                    <AccordionTrigger className='w-full py-2 flex items-center justify-between'>
                        ...
                        <ChevronDown className={cn("h-6 w-6 transition-all text-muted-foreground -my-2", {
